...
const opinion_interface_1 = require("../opinion/opinion.interface");
...
], RestauranteController.prototype, "obtenerTodos", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], RestauranteController.prototype, "obtenerUno", null);
__decorate([
    common_1.Post(),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], RestauranteController.prototype, "crear", null);
__decorate([
    common_1.Post(':id'),
    __param(0, common_1.Param('id')),
    ...
    __metadata("design:returntype", Promise)
], RestauranteController.prototype, "agregarOpinion", null);
RestauranteController = __decorate([
    common_1.Controller('restaurantes'),
